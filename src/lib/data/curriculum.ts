...
bleibt offen — erfinde nichts.`,
      ...
      },
      {
        ...
        videoUrl: "https://videos.gefundenwerden.online/modul-1/programmatic-seo.mp4?v=3",
        description:
          "Programmatic SEO heißt: Du schreibst nicht für jeden Suchbegriff eine eigene Seite von Hand — du baust EINE gute Vorlage, und daraus entstehen nach System viele Seiten, eine je Kombination aus Leistung und Ort: /heizung-reparatur/leverkusen, /moebel/landstuhl. Warum das zieht: Niemand sucht ‚Heizungsbauer', gesucht wird Leistung plus Ort — und eine Seite rankt meist nur für einen einzigen Begriff. Die Gefahr dabei: Ähneln sich die Seiten zu stark, wertet Google alles ab. Deshalb baut Claude nur, wofür es echte Nachfrage gibt (Suchvolumen) und echten Ortsbezug (dein Interview) — mit eingebauter Bremse.",
        duration: 9,
        kind: "video",
        seoPrompt: true,
        steps: [
          "Wann dieser Hebel zündet: Eine Seite rankt meist nur für einen einzigen Suchbegriff — und die großen Begriffe wie „Möbelhaus“ gehören den Konzernen. Gesucht wird lokal, Leistung plus Ort. Gerade im Handwerk ist das der stärkste Hebel überhaupt.",
          "Am Regler rechts das Einzugsgebiet einstellen — und der Praxis-Tipp aus dem Video: Ein ganzes Land auswählen ergibt hier keinen Sinn, sinnvoll sind meist 40 bis 50 Kilometer.",
          ...
          "Das Endergebnis im Video: fünf Orts-Seiten nach dem Muster /leistung/ort (durch die englische Version sogar zehn) — und der Ähnlichkeits-Check zeigt nur 22,5 Prozent gleiche Inhalte, sicher unter der Schwelle, ab der Google Seiten als Kopien abstraft. Genau so sieht „mehr Seiten ohne Ärger“ aus.",
...
kommt, steht nicht auf der Seite.`,
      ...
      },
      {
        ...
        steps: [
          ...
          "Voraussetzung: Higgsfield ist als Connector verbunden — das kennst du aus der KI-Bilder-Lektion (Plus-Zeichen → Connectoren → „Higgs“ suchen, anmelden). Wichtig: Die kostenlose Version reicht für eine Website völlig, keine Pro nötig.",
